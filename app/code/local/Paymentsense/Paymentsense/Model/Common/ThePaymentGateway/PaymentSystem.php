<?php
	...
	if (!defined('COMPILER_INCLUDE_PATH')) {
		...
		include_once ("Paymentsense_Paymentsense_Model_Common_ThePaymentGateway_SOAP.php");
	}
    	
	/*****************/
	/* Input classes */
	/*****************/
	class PS_CSV_RequestGatewayEntryPoint extends PS_CSV_GatewayEntryPoint
	{
	  	...
	  	public function __construct($szEntryPointURL, $nMetric, $nRetryAttempts)
	   	{
	   		...
	   		PS_CSV_GatewayEntryPoint::__construct($szEntryPointURL, $nMetric);
	   		
	     	$this->m_nRetryAttempts = $nRetryAttempts;
	   	}
	}

	class PS_CSV_RequestGatewayEntryPointList
	{
		...
		{
			array_push($this->m_lrgepRequestGatewayEntryPoint, new PS_CSV_RequestGatewayEntryPoint($EntryPointURL, $nMetric, $nRetryAttempts));
		}
	...
	class PS_CSV_GenericVariableList
	{
		...
		public function add($szName, $szValue)
		{
			if ($szName != null &&
				$szName != "")
			{
				$genericVariable = new PS_CSV_GenericVariable();
	...
	class PS_CSV_CustomerDetails
	{
	    ...
	    public function __construct()
	    {
	    	$this->m_adBillingAddress = new PS_CSV_BillingAddress();
	...
	class PS_CSV_BillingAddress
	{
	    ...
	    public function __construct()
	    {
	    	...
	    	$this->m_szState = "";
	    	$this->m_szPostCode = "";
	    	$this->m_nCountryCode = new PS_CSV_NullableInt();
	    }
	}

	abstract class PS_CSV_CreditCardDate
	{
		private  $m_nMonth;
	    private $m_nYear;
	    ...
	    public function __construct()
	    {
	    	$this->m_nMonth = new PS_CSV_NullableInt();
	    	$this->m_nYear = new PS_CSV_NullableInt();
	    }
	}

	class PS_CSV_ExpiryDate extends PS_CSV_CreditCardDate
	{
	    public function __construct()
	    {
	      	parent::__construct();
	...
	class PS_CSV_StartDate extends PS_CSV_CreditCardDate
	{
	    public function __construct()
	    {
	      	parent::__construct();
	...
	class PS_CSV_CardDetails
	{
	    ...
	    public function __construct()
	    {
	    	$this->m_szCardName = "";
	    	$this->m_szCardNumber = "";
	    	$this->m_edExpiryDate = new PS_CSV_ExpiryDate();
	    	$this->m_sdStartDate = new PS_CSV_StartDate();
	    	$this->m_szIssueNumber = "";
	    	$this->m_szCV2 = "";
	    }
	}

	class PS_CSV_OverrideCardDetails extends PS_CSV_CardDetails
	{
	    public function __construct()
	    {
			parent::__construct();
	...
	class PS_CSV_MerchantAuthentication
	{
	...
	class PS_CSV_MessageDetails
	{
	    ...
	    public function PS_GetCrossReference()
	    {
	    ...
	    public function __construct()
	    {
	    	...
	    	$this->m_boNewTransaction = new PS_CSV_NullableBool();
	    }
	}

	class PS_CSV_TransactionDetails
	{
	    ...
	    public function __construct()
	    {
			$this->m_mdMessageDetails = new PS_CSV_MessageDetails();
	    	$this->m_nAmount = new PS_CSV_NullableInt();
	    	$this->m_nCurrencyCode = new PS_CSV_NullableInt();
	    	$this->m_szOrderID = "";
	    	$this->m_szOrderDescription = "";
	    	$this->m_tcTransactionControl = new PS_CSV_TransactionControl();
	    	$this->m_tdsbdThreeDSecureBrowserDetails = new PS_CSV_ThreeDSecureBrowserDetails();
	    }
	}

	class PS_CSV_ThreeDSecureBrowserDetails
	{
	    ...
	    public function __construct()
	    {
	    	$this->m_nDeviceCategory = new PS_CSV_NullableInt();
	    	$this->m_szAcceptHeaders = "";
	    	$this->m_szUserAgent = "";	
	    }
	}
	    
	class PS_CSV_TransactionControl
	{
	    ...
	    public function __construct()
	    {
	    	$this->m_boEchoCardType = new PS_CSV_NullableBool();
	    	$this->m_boEchoAVSCheckResult = new PS_CSV_NullableBool();
	    	$this->m_boEchoCV2CheckResult = new PS_CSV_NullableBool;
	    	$this->m_boEchoAmountReceived = new PS_CSV_NullableBool;
	    	$this->m_nDuplicateDelay = new PS_CSV_NullableInt;
	    	$this->m_szAVSOverridePolicy = "";
	    	$this->m_szCV2OverridePolicy = "";
	    	$this->m_boThreeDSecureOverridePolicy = new PS_CSV_NullableBool();
	    	$this->m_szAuthCode = "";
	    	$this->m_tdsptThreeDSecurePassthroughData = new PS_CSV_ThreeDSecurePassthroughData();
	    	$this->m_lgvCustomVariables = new PS_CSV_GenericVariableList();
	    }
	}

	class PS_CSV_ThreeDSecureInputData
	{
		private $m_szCrossReference;
	    private $m_szPaRES;
	...
	class PS_CSV_ThreeDSecurePassthroughData
	{
	...
	class PS_CSV_CardTypeData
	{
	    ...
	    //constructor
	    public function __construct($szCardType, $iIssuer, PS_CSV_NullableBool $boLuhnCheckRequired = null, $szIssueNumberStatus, $szStartDateStatus)
	    {
	...
	class PS_CSV_GatewayEntryPoint
	{
	...
	class PS_CSV_GatewayEntryPointList
	{
	    ...
	    {
	    	array_push($this->m_lgepGatewayEntryPoint, new PS_CSV_GatewayEntryPoint($GatewayEntrypointOrEntrypointURL, $nMetric));
	    }
	...
	class PS_CSV_PreviousTransactionResult
	{
	    ...
	    function __construct(PS_CSV_NullableInt $nStatusCode = null,
	    					 $szMessage)
	    {
	...
	class PS_CSV_GatewayOutput
	{
	    ...
	    //constructor
	    public function __construct($nStatusCode, $szMessage, PS_CSV_StringList $lszErrorMessages = null)
	    {
		    $this->m_nStatusCode = $nStatusCode;
			$this->m_szMessage = $szMessage;
	...
	class PS_CSV_PaymentMessageGatewayOutput extends PS_CSV_GatewayOutput
	{
	    ...
	    //constructor
	    public function __construct($nStatusCode, $szMessage, PS_CSV_NullableBool $boAuthorisationAttempted = null, PS_CSV_PreviousTransactionResult $ptdPreviousTransactionResult = null, PS_CSV_StringList $lszErrorMessages = null)
	    {
	...
	class PS_CSV_CardDetailsTransactionResult extends PS_CSV_PaymentMessageGatewayOutput
	{
	    public function __construct($nStatusCode, $szMessage, PS_CSV_NullableBool $boAuthorisationAttempted = null, PS_CSV_PreviousTransactionResult $ptdPreviousTransactionResult = null, PS_CSV_StringList $lszErrorMessages = null)
	    {
	...
	class PS_CSV_CrossReferenceTransactionResult extends PS_CSV_PaymentMessageGatewayOutput
	{
	    public function __construct($nStatusCode, $szMessage, PS_CSV_NullableBool $boAuthorisationAttempted = null, PS_CSV_PreviousTransactionResult $ptdPreviousTransactionResult = null, PS_CSV_StringList $lszErrorMessages = null)
	    {
			parent::__construct($nStatusCode, $szMessage, $boAuthorisationAttempted, $ptdPreviousTransactionResult, $lszErrorMessages);
	...
	class PS_CSV_ThreeDSecureTransactionResult extends PS_CSV_PaymentMessageGatewayOutput
	{
	    public function __construct($nStatusCode, $szMessage, PS_CSV_NullableBool $boAuthorisationAttempted = null, PS_CSV_PreviousTransactionResult $ptdPreviousTransactionResult = null, PS_CSV_StringList $lszErrorMessages = null)
	    {
			parent::__construct($nStatusCode, $szMessage, $boAuthorisationAttempted, $ptdPreviousTransactionResult, $lszErrorMessages);
	...
	class PS_CSV_GetGatewayEntryPointsResult extends PS_CSV_GatewayOutput
	{
	    public function __construct($nStatusCode, $szMessage, PS_CSV_StringList $lszErrorMessages = null)
	    {
			parent::__construct($nStatusCode, $szMessage, $lszErrorMessages);
	...
	class PS_CSV_GetCardTypeResult extends PS_CSV_GatewayOutput
	{
	    public function __construct($nStatusCode, $szMessage, PS_CSV_StringList $lszErrorMessages = null)
	    {
			parent::__construct($nStatusCode, $szMessage, $lszErrorMessages);
	...
	class PS_CSV_ThreeDSecureOutputData
	{
		private $m_szPaREQ;
	   	private $m_szACSURL;
	...
	class PS_CSV_GetGatewayEntryPointsOutputData extends PS_CSV_BaseOutputData
	{
	   	//constructor
	...
	class PS_CSV_TransactionOutputData extends PS_CSV_BaseOutputData
	{
		private $m_szCrossReference;
		private $m_szAuthCode;
	    ...
	    public function __construct($szCrossReference,
	    							...
	    							$szCV2CheckResult,
	    							PS_CSV_CardTypeData $ctdCardTypeData = null,
	    							PS_CSV_NullableInt $nAmountReceived = null,
	    							PS_CSV_ThreeDSecureOutputData $tdsodThreeDSecureOutputData = null,
	    							PS_CSV_GenericVariableList $lgvCustomVariables = null,
	    							PS_CSV_GatewayEntryPointList $lgepGatewayEntryPoints = null)
	    {
	...
	class PS_CSV_GetCardTypeOutputData extends PS_CSV_BaseOutputData
	{
		private $m_ctdCardTypeData;
	  	...
	  	//constructor
	   	public function __construct(PS_CSV_CardTypeData $ctdCardTypeData = null,
	   								PS_CSV_GatewayEntryPointList $lgepGatewayEntryPoints = null)
	   	{
	      	parent::__construct($lgepGatewayEntryPoints);
	...
	class PS_CSV_BaseOutputData
	{
	   	...
	   	//constructor
	   	public function __construct(PS_CSV_GatewayEntryPointList $lgepGatewayEntryPoints = null)
	   	{
	...
	/* Gateway messages */
	/********************/
	class PS_CSV_GetGatewayEntryPoints extends PS_CSV_GatewayTransaction
	{
	  	function processTransaction(PS_CSV_GetGatewayEntryPointsResult &$ggeprGetGatewayEntryPointsResult = null, PS_CSV_GetGatewayEntryPointsOutputData &$ggepGetGatewayEntryPointsOutputData = null)
	   	{
	      	...
	      	$sSOAPClient = new PS_CSV_SOAP('GetGatewayEntryPoints', PS_CSV_GatewayTransaction::getSOAPNamespace());
	      
	      	$boTransactionSubmitted = PS_CSV_GatewayTransaction::processTransactionBase($sSOAPClient, 'GetGatewayEntryPointsMessage', 'GetGatewayEntryPointsResult', 'GetGatewayEntryPointsOutputData', $sxXmlDocument, $goGatewayOutput, $lgepGatewayEntryPoints);
	      
	      	if ($boTransactionSubmitted)
	      	{
				$ggeprGetGatewayEntryPointsResult = $goGatewayOutput;

	      		$ggepGetGatewayEntryPointsOutputData = new PS_CSV_GetGatewayEntryPointsOutputData($lgepGatewayEntryPoints);
	      	}
	   	...
	   	//constructor
	   	public function __construct(PS_CSV_RequestGatewayEntryPointList $lrgepRequestGatewayEntryPoints = null,
	   								$nRetryAttempts = 1,
	   								PS_CSV_NullableInt $nTimeout = null)
	 	{
	   		if ($nRetryAttempts == null &&
	   			$nTimeout == null)
	   		{
	   			PS_CSV_GatewayTransaction::__construct($lrgepRequestGatewayEntryPoints, 1, null);
	   		}
	   		else 
	   		{
	   			PS_CSV_GatewayTransaction::__construct($lrgepRequestGatewayEntryPoints, $nRetryAttempts, $nTimeout);
	   		}
	   	}
	}


	class PS_CSV_CardDetailsTransaction extends PS_CSV_GatewayTransaction
	{
	   	...
	   	public function getCustomerDetails()
	    {
	   	...
	   	public function processTransaction(PS_CSV_CardDetailsTransactionResult &$cdtrCardDetailsTransactionResult = null, PS_CSV_TransactionOutputData &$todTransactionOutputData = null)
	   	{
	     	$boTransactionSubmitted = false;
	        $sSOAPClient;
	        ...
	        $sSOAPClient = new PS_CSV_SOAP('CardDetailsTransaction', parent::getSOAPNamespace());
	       	...
	       	if ($this->m_tdTransactionDetails != null)
	        {
	            ...
	            {
	            	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getMessageDetails()->getTransactionType()))
	                {
	            ...
	            if ($this->m_tdTransactionDetails->getTransactionControl() != null)
	           	{
	             	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getAuthCode()))
	                {
	                ...
	                if ($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecureOverridePolicy() != null)
	                {
	                    ...
	                    {
		                	$sSOAPClient->addParam('PaymentMessage.TransactionDetails.TransactionControl.ThreeDSecureOverridePolicy', PS_CSV_SharedFunctions::boolToString($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecureOverridePolicy()->getValue()));
						}
	               	}
	               	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getAVSOverridePolicy()))
	                {
	                ...
	                if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getCV2OverridePolicy()))
	                {
	                ...
	                if ($this->m_tdTransactionDetails->getTransactionControl()->getEchoCardType() != null)
	                {
	                    ...
	                    {
	                    	$sSOAPClient->addParam('PaymentMessage.TransactionDetails.TransactionControl.EchoCardType', PS_CSV_SharedFunctions::boolToString($this->m_tdTransactionDetails->getTransactionControl()->getEchoCardType()->getValue()));
	                    }
	                }
	                if ($this->m_tdTransactionDetails->getTransactionControl()->getEchoAVSCheckResult() != null)
	                {
	                    ...
	                    {
	                    	$sSOAPClient->addParam('PaymentMessage.TransactionDetails.TransactionControl.EchoAVSCheckResult', PS_CSV_SharedFunctions::boolToString($this->m_tdTransactionDetails->getTransactionControl()->getEchoAVSCheckResult()->getValue()));
	                  	}
	                }
	                if ($this->m_tdTransactionDetails->getTransactionControl()->getEchoAVSCheckResult() != null)
	                {
	                ...
	                if ($this->m_tdTransactionDetails->getTransactionControl()->getEchoCV2CheckResult() != null)
	                {
	                    ...
	                    {
	                    	$sSOAPClient->addParam('PaymentMessage.TransactionDetails.TransactionControl.EchoCV2CheckResult', PS_CSV_SharedFunctions::boolToString($this->m_tdTransactionDetails->getTransactionControl()->getEchoCV2CheckResult()->getValue()));
	                    }
	               	}
	                if ($this->m_tdTransactionDetails->getTransactionControl()->getEchoAmountReceived() != null)
	                {
	                    ...
	                    {
	                    	$sSOAPClient->addParam('PaymentMessage.TransactionDetails.TransactionControl.EchoAmountReceived', PS_CSV_SharedFunctions::boolToString($this->m_tdTransactionDetails->getTransactionControl()->getEchoAmountReceived()->getValue()));
	                    }
	                }
	                if ($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecurePassthroughData() != null)
	                {
	                	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecurePassthroughData()->getEnrolmentStatus()))
	                	{
	                	...
	                	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecurePassthroughData()->getAuthenticationStatus()))
	                	{
	                	...
	                	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecurePassthroughData()->getElectronicCommerceIndicator()))
	                	{
	                	...
	                	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecurePassthroughData()->getAuthenticationValue()))
	                	{
	                	...
	                	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getTransactionControl()->getThreeDSecurePassthroughData()->getTransactionIdentifier()))
	                	{
	            ...
	            {
	            	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getThreeDSecureBrowserDetails()->getAcceptHeaders()))
	                {
	                ...
	                if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getThreeDSecureBrowserDetails()->getUserAgent()))
	                {
	            ...
	            if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getOrderID()))
	           	{
	             	$sSOAPClient->addParam('PaymentMessage.TransactionDetails.OrderID', $this->m_tdTransactionDetails->getOrderID());
	            }
	            if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getOrderDescription()))
	            {
	        ...
	        {
	        	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_cdCardDetails->getCardName()))
	            {
	            	$sSOAPClient->addParam('PaymentMessage.CardDetails.CardName', $this->m_cdCardDetails->getCardName());
	            }
	        	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_cdCardDetails->getCV2()))
	            {
	                $sSOAPClient->addParam('PaymentMessage.CardDetails.CV2', $this->m_cdCardDetails->getCV2());
	            }
	            if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_cdCardDetails->getCardNumber()))
	            {
	        	...
	        	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_cdCardDetails->getIssueNumber()))
	            {
	        ...
	        if ($this->m_cdCustomerDetails != null)
	        {
	            ...
	            {
	             	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getBillingAddress()->getAddress1()))
	                {
	                ...
	                if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getBillingAddress()->getAddress2()))
	                {
	                ...
	                if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getBillingAddress()->getAddress3()))
	                {
	                ...
	                if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getBillingAddress()->getAddress4()))
	                {
	                ...
	                if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getBillingAddress()->getCity()))
	                {
	                ...
	                if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getBillingAddress()->getState()))
	                {
	                ...
	                if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getBillingAddress()->getPostCode()))
	                {
	            ...
	            if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getEmailAddress()))
	            {
	            	$sSOAPClient->addParam('PaymentMessage.CustomerDetails.EmailAddress', $this->m_cdCustomerDetails->getEmailAddress());
	            }
	            if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getPhoneNumber()))
	            {
	              	$sSOAPClient->addParam('PaymentMessage.CustomerDetails.PhoneNumber', $this->m_cdCustomerDetails->getPhoneNumber());
	            }
	            if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_cdCustomerDetails->getCustomerIPAddress()))
	            {
	            	$sSOAPClient->addParam('PaymentMessage.CustomerDetails.CustomerIPAddress', $this->m_cdCustomerDetails->getCustomerIPAddress());
	            }
	       	}
	       	
	       	$boTransactionSubmitted = PS_CSV_GatewayTransaction::processTransactionBase($sSOAPClient, 'PaymentMessage', 'CardDetailsTransactionResult', 'TransactionOutputData', $sxXmlDocument, $goGatewayOutput, $lgepGatewayEntryPoints);

			if ($boTransactionSubmitted)
			{
				$cdtrCardDetailsTransactionResult = PS_CSV_SharedFunctionsPaymentSystemShared::getPaymentMessageGatewayOutput($sxXmlDocument->CardDetailsTransactionResult, $goGatewayOutput);
	
				$todTransactionOutputData = PS_CSV_SharedFunctionsPaymentSystemShared::getTransactionOutputData($sxXmlDocument, $lgepGatewayEntryPoints);
			}
		...
		public function __construct(PS_CSV_RequestGatewayEntryPointList $lrgepRequestGatewayEntryPoints = null,
	     							...
	     							PS_CSV_NullableInt $nTimeout = null)
	  	{
	        ...
	        $this->m_tdTransactionDetails = new PS_CSV_TransactionDetails();
	        $this->m_cdCardDetails = new PS_CSV_CardDetails();
	        $this->m_cdCustomerDetails = new PS_CSV_CustomerDetails();
	    }
	     
	}
	class PS_CSV_CrossReferenceTransaction extends PS_CSV_GatewayTransaction
	{
		private $m_tdTransactionDetails;
	    ...
	    public function processTransaction(PS_CSV_CrossReferenceTransactionResult &$crtrCrossReferenceTransactionResult = null, PS_CSV_TransactionOutputData &$todTransactionOutputData = null)
	    {
	    	$boTransactionSubmitted = false;
	        $sSOAPClient;
	        $lgepGatewayEntryPoints = null;
	        ...
	        $sSOAPClient = new PS_CSV_SOAP('CrossReferenceTransaction', PS_CSV_GatewayTransaction::getSOAPNamespace());
	      	// transaction details
	        if ($this->m_tdTransactionDetails != null)
	        {
	        	if ($this->m_tdTransactionDetails->getAmount() != null)
	            ...
	            if ($this->m_tdTransactionDetails->getMessageDetails() != null)
	            {
	                ...
	                if ($this->m_tdTransactionDetails->getMessageDetails()->getNewTransaction() != null)
	                {
	                    ...
	                    {
	                        $sSOAPClient->addParamAttribute('PaymentMessage.TransactionDetails.MessageDetails', 'NewTransaction', PS_CSV_SharedFunctions::boolToString($this->m_tdTransactionDetails->getMessageDetails()->getNewTransaction()->getValue()));
	                    }
	                }
	                if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_tdTransactionDetails->getMessageDetails()->PS_GetCrossReference()))
	                {
	                	$sSOAPClient->addParamAttribute('PaymentMessage.TransactionDetails.MessageDetails', 'CrossReference', $this->m_tdTransactionDetails->getMessageDetails()->PS_GetCrossReference());
	                }
	           	}
	           	if ($this->m_tdTransactionDetails->getTransactionControl() != null)
	           	{
	        ...
	        {
	        	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_ocdOverrideCardDetails->getCardName()))
	            {
	            	$sSOAPClient->addParam('PaymentMessage.OverrideCardDetails.CardName', $this->m_ocdOverrideCardDetails->getCardName());
	            }
	        	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_ocdOverrideCardDetails->getCV2()))
	            {
	                $sSOAPClient->addParam('PaymentMessage.CardDetails.CV2', $this->m_ocdOverrideCardDetails->getCV2());
	            }
	            if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_ocdOverrideCardDetails->getCardNumber()))
	            {
	        	...
	        	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_ocdOverrideCardDetails->getIssueNumber()))
	            {
	        ...
	        $boTransactionSubmitted = PS_CSV_GatewayTransaction::processTransactionBase($sSOAPClient, 'PaymentMessage', 'CrossReferenceTransactionResult', 'TransactionOutputData', $sxXmlDocument, $goGatewayOutput, $lgepGatewayEntryPoints);

	       	if ($boTransactionSubmitted)
	        {
				$crtrCrossReferenceTransactionResult = PS_CSV_SharedFunctionsPaymentSystemShared::getPaymentMessageGatewayOutput($sxXmlDocument->CrossReferenceTransactionResult, $goGatewayOutput);
	    							...
	    							PS_CSV_NullableInt $nTimeout = null)
	    {
		    ...
		    $this->m_tdTransactionDetails = new PS_CSV_TransactionDetails();
	      	$this->m_ocdOverrideCardDetails = new PS_CSV_OverrideCardDetails();
	       	$this->m_cdCustomerDetails = new PS_CSV_CustomerDetails();
	    }
	}

	class PS_CSV_ThreeDSecureAuthentication extends PS_CSV_GatewayTransaction
	{
		...
		public function processTransaction(CSV_ThreeDSecureAuthenticationResult &$tdsarThreeDSecureAuthenticationResult = null, PS_CSV_TransactionOutputData &$todTransactionOutputData = null)
		{
			$boTransactionSubmitted = false;
	        $sSOAPClient;
	        $lgepGatewayEntryPoints = null;
	        ...
	        $goGatewayOutput = null;
	       	...
	       	$sSOAPClient = new PS_CSV_SOAP('ThreeDSecureAuthentication', PS_CSV_GatewayTransaction::getSOAPNamespace());
	       	if ($this->m_tdsidThreeDSecureInputData != null)
	        {
	        	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_tdsidThreeDSecureInputData->PS_GetCrossReference()))
	            {
	                $sSOAPClient->addParamAttribute('ThreeDSecureMessage.ThreeDSecureInputData', 'CrossReference', $this->m_tdsidThreeDSecureInputData->PS_GetCrossReference());
	            }
	            if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_tdsidThreeDSecureInputData->getPaRES()))
	            {
	            	$sSOAPClient->addParam('ThreeDSecureMessage.ThreeDSecureInputData.PaRES', $this->m_tdsidThreeDSecureInputData->getPaRES());
	            }
	        }
	        
	        $boTransactionSubmitted = PS_CSV_GatewayTransaction::processTransactionBase($sSOAPClient, 'ThreeDSecureMessage', 'ThreeDSecureAuthenticationResult', 'TransactionOutputData', $sxXmlDocument, $goGatewayOutput, $lgepGatewayEntryPoints);
	       	
	        if ($boTransactionSubmitted)
	      	{
				$tdsarThreeDSecureAuthenticationResult = PS_CSV_SharedFunctionsPaymentSystemShared::getPaymentMessageGatewayOutput($sxXmlDocument->ThreeDSecureAuthenticationResult, $goGatewayOutput);
		...
		public function __construct(PS_CSV_RequestGatewayEntryPointList $lrgepRequestGatewayEntryPoints = null,
									...
									PS_CSV_NullableInt $nTimeout = null)
	 	{
	    	...
	    	$this->m_tdsidThreeDSecureInputData = new PS_CSV_ThreeDSecureInputData();
	    }
	}

	class PS_CSV_GetCardType extends PS_CSV_GatewayTransaction
	{
		private $m_szCardNumber;
		...
		public function processTransaction(PS_CSV_GetCardTypeResult &$gctrGetCardTypeResult = null, PS_CSV_GetCardTypeOutputData &$gctodGetCardTypeOutputData = null)
		{
			$boTransactionSubmitted = false;
	        $sSOAPClient;
	       	$lgepGatewayEntryPoints = null;
	        ...
	        $goGatewayOutput = null;
	      	...
	      	$sSOAPClient = new PS_CSV_SOAP('GetCardType', PS_CSV_GatewayTransaction::getSOAPNamespace());
	      	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_szCardNumber))
	       	{
	        	$sSOAPClient->addParam('GetCardTypeMessage.CardNumber', $this->m_szCardNumber);
	        }
	        
	        $boTransactionSubmitted = PS_CSV_GatewayTransaction::processTransactionBase($sSOAPClient, 'GetCardTypeMessage', 'GetCardTypeResult', 'GetCardTypeOutputData', $sxXmlDocument, $goGatewayOutput, $lgepGatewayEntryPoints);
	        ...
	        if ($boTransactionSubmitted)
	        {
	        	...
	        	{
	            	$ctdCardTypeData = PS_CSV_SharedFunctionsPaymentSystemShared::getCardTypeData($sxXmlDocument->GetCardTypeOutputData->CardTypeData);
	        	}
	        	
	            if (!is_null($ctdCardTypeData)) 
	            {
	                $gctodGetCardTypeOutputData = new PS_CSV_GetCardTypeOutputData($ctdCardTypeData, $lgepGatewayEntryPoints);
	            } 
			}
	        return $boTransactionSubmitted;
		}
	...
	abstract class PS_CSV_GatewayTransaction
	{
		...
		private $m_szEntryPointUsed;
	   	...
	   	public static function compare($x, $y)
	   	{
	      	...
	      	return (PS_CSV_GatewayTransaction::compareGatewayEntryPoints($rgepFirst, $rgepSecond));
	   	}
	   	private static function compareGatewayEntryPoints(PS_CSV_RequestGatewayEntryPoint $rgepFirst, PS_CSV_RequestGatewayEntryPoint $rgepSecond)
	   	{
			$nReturnValue = 0;
	   	...
	   	protected function processTransactionBase(PS_CSV_SOAP $sSOAPClient, $szMessageXMLPath, $szGatewayOutputXMLPath, $szTransactionMessageXMLPath, SimpleXMLElement &$sxXmlDocument = null, PS_CSV_GatewayOutput &$goGatewayOutput = null, PS_CSV_GatewayEntryPointList &$lgepGatewayEntryPoints = null)
	   	{
			$boTransactionSubmitted = false;
			...
			$this->m_szEntryPointUsed = null;
	      	...
	      	if ($sSOAPClient == null)
	      	{
	       	...
	       	{
	        	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_maMerchantAuthentication->getMerchantID()))
	          	{
	          	...
	          	if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($this->m_maMerchantAuthentication->getPassword()))
	          	{
	      	...
	      	// first need to sort the gateway entry points into the correct usage order
	       	$number = $this->m_lrgepRequestGatewayEntryPoints->sort('PS_CSV_GatewayTransaction','Compare');
	                    ...
	                    while (!$boTransactionSubmitted &&
	                          	$nGatewayEntryPointCount < $rgepCurrentGatewayEntryPoint->getRetryAttempts())
	                  	{
	                    	if ($sSOAPClient->sendRequest($ResponseDocument, $ResponseMethod))
	                        {
	                        	...
	                        	$lszErrorMessages = new PS_CSV_StringList();
								...
								if ($nStatusCode != 50)
								{
									...
									$goGatewayOutput = new PS_CSV_GatewayOutput($nStatusCode, $szMessage, $lszErrorMessages);
		                            ...
		                            if ($ResponseDocument->$ResponseMethod->$szTransactionMessageXMLPath->GatewayEntryPoints)
		                            {
		                            	if($ResponseDocument->$ResponseMethod->$szTransactionMessageXMLPath->GatewayEntryPoints->GatewayEntryPoint)
		                            	{
				                            ...
				                            //$gepGatewayEntryPoint = new PS_CSV_GatewayEntryPoint($szEntryPointURL, $nMetric);
				                            if ($lgepGatewayEntryPoints == null)
				                            {
				                            	$lgepGatewayEntryPoints = new PS_CSV_GatewayEntryPointList();
				                            }
		...
		public function __construct(PS_CSV_RequestGatewayEntryPointList $lrgepRequestGatewayEntryPoints = null,
									...
									PS_CSV_NullableInt $nTimeout = null)
		{
			$this->m_maMerchantAuthentication = new PS_CSV_MerchantAuthentication();
	...
	class PS_CSV_SharedFunctionsPaymentSystemShared
	{
		public static function getTransactionOutputData(SimpleXMLElement $sxXmlDocument, PS_CSV_GatewayEntryPointList $lgepGatewayEntryPoints = null)
		{
			...
			{
		    	$nAmountReceived = new PS_CSV_NullableInt(current($sxXmlDocument->TransactionOutputData->AmountReceived[0]));
			}
			else 
			{
				$nAmountReceived = new PS_CSV_NullableInt(null);
			}
		    ...
		    if (!PS_CSV_SharedFunctions::isStringNullOrEmpty($szACSURL) &&
		    	!PS_CSV_SharedFunctions::isStringNullOrEmpty($szPaREQ))
		    {
		    	$tdsodThreeDSecureOutputData = new PS_CSV_ThreeDSecureOutputData($szPaREQ, $szACSURL);
		    }
			...
			if ($sxXmlDocument->TransactionOutputData->CustomVariables->GenericVariable)
			{
				...
				{
					$lgvCustomVariables = new PS_CSV_GenericVariableList();
				}
				for ($nCount=0; $nCount < count($sxXmlDocument->TransactionOutputData->CustomVariables->GenericVariable); $nCount++)
				{
					...
					$gvGenericVariable = new PS_CSV_GenericVariable();
		    ...
		    $todTransactionOutputData = new PS_CSV_TransactionOutputData($szCrossReference,
																  $szAuthCode,
															      $szAddressNumericCheckResult,
															      $szPostCodeCheckResult,
															      $szThreeDSecureAuthenticationCheckResult,
		...
		public static function getCardTypeData($CardTypeDataTag)
		{
			...
			if ($CardTypeDataTag->Issuer)
			{
				...
				$iIssuer = new PS_CSV_Issuer($szIssuer, $nISOCode);
			}
			else 
			{
				$iIssuer = null;
			...
			{
				$boLuhnCheckRequired = new PS_CSV_NullableBool(current($CardTypeDataTag->LuhnCheckRequired[0]));
			}
			else 
			{
				$boLuhnCheckRequired = null;
			...
			$ctdCardTypeData = new PS_CSV_CardTypeData($szCardType, $iIssuer, $boLuhnCheckRequired, $szIssueNumberStatus, $szStartDateStatus);

	        return ($ctdCardTypeData);
		}

	   	public static function getPaymentMessageGatewayOutput($GatewayOutput, PS_CSV_GatewayOutput $goGatewayOutput = null)
	   	{
			...
			if ($GatewayOutput->attributes())
			{
				try
				{
					...
					{
						$boAuthorisationAttempted = new PS_CSV_NullableBool(false);
					}
					elseif (strtolower($boAuthorisationAttempted) == 'true')
					{
						$boAuthorisationAttempted = new PS_CSV_NullableBool(true);
					}
					else 
					{
			...
			{
				$nPreviousStatusCode = new PS_CSV_NullableInt(current($GatewayOutput->PreviousTransactionResult->StatusCode[0]));
			}
			...
			if ($nPreviousStatusCode != null &&
				!PS_CSV_SharedFunctions::isStringNullOrEmpty($szPreviousMessage))
			{
				$ptdPreviousTransactionResult = new PS_CSV_PreviousTransactionResult($nPreviousStatusCode, $szPreviousMessage);
			}

			$pmgoPaymentMessageGatewayOutput = new PS_CSV_PaymentMessageGatewayOutput($goGatewayOutput->getStatusCode(),
